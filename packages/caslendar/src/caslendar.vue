<template>
  <div :style='{"width": width,}'>
    <el-select
      ...
      placeholder="省"
    >
      <el-option v-for="item in province" :key="item.id" :label="item.mapName" :value="item.id"></el-option>
    </el-select>
    <el-select
      :popper-append-to-body="false"
      :disabled="disabled"
      ...
      placeholder="市"
    >
      <el-option v-for="item in city" :key="item.id" :label="item.mapName" :value="item.id"></el-option>
    </el-select>
    <el-select
      :popper-append-to-body="false"
      :disabled="disabled"
      ...
      placeholder="区"
    >
      <el-option v-for="item in area" :key="item.id" :label="item.mapName" :value="item.id"></el-option>
    </el-select>
    <el-input
      :disabled="disabled"
      style="width: 50%"
